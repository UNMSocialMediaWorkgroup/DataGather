...
public class MainActivity extends Activity implements SensorEventListener{
	...
	public void onSensorChanged(SensorEvent event){
        ...
        if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
    		...
    		time.setToNow();
			currentDataPoint.setAccelXYZ(linear_acceleration, time.toMillis(false) );
			currentDataPoint.setWritten();
	...
	public void packDataPoints() {
    	...
    	try {	
    		...
    		for(int i = post_index; i < post_index+post_chunksize; i++)
        	{
				...
				pointJsonObject.put("accel" , point.getCompressedAccelString());
				...
				pointJsonObject.put("light", point.getCompressedBrightnessString());
	...
	public void updateUI_Motion() {
  		txtview_accelX.setText(Float.toString(currentDataPoint.getCurrentAccelX()) + "m/s\u00B2");
  		txtview_accelY.setText(Float.toString(currentDataPoint.getCurrentAccelY()) + "m/s\u00B2");
  		txtview_accelZ.setText(Float.toString(currentDataPoint.getCurrentAccelZ()) + "m/s\u00B2");
	...
	public void updateUI_Light() {
		txtview_light.setText(Float.toString(currentDataPoint.getCurrentBrightness()));
	}
